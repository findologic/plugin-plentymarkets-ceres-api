...
var _url = _interopRequireDefault(require("../../mixins/url"));
  ...
  methods: {
    updateSorting: function updateSorting() {
      this.setUrlParamValues([{
        key: _constants["default"].PARAMETER_SORTING,
        value: this.selectedSorting
      }, {
        key: _constants["default"].PARAMETER_PAGE,
        value: 1
      }]);
    },
...
Vue.component("items-per-page", {
  ...
  methods: {
    itemsPerPageChanged: function itemsPerPageChanged() {
      this.setUrlParamValues([{
        key: _constants["default"].PARAMETER_ITEMS,
  ...
  methods: {
    ...
    getUrlParams: function getUrlParams(urlParams) {
      if (urlParams) {
        ...
        var params = {};
        var regex = /[?&]?([^=]+)=([^&]*)/g;
        urlParams = urlParams.split("+").join(" "); // eslint-disable-next-line
    ...
    getSearchParams: function getSearchParams() {
      ...
      if (requestParameters[_constants["default"].PARAMETER_ATTRIBUTES] === '') {
        delete requestParameters[_constants["default"].PARAMETER_ATTRIBUTES];
      }
    ...
    updateSelectedFilters: function updateSelectedFilters(facetId, facetValue) {
      ...
      if (!(_constants["default"].PARAMETER_ATTRIBUTES in params)) {
        params[_constants["default"].PARAMETER_ATTRIBUTES] = {};
      }

      var attributes = params[_constants["default"].PARAMETER_ATTRIBUTES];
      ...
      params[_constants["default"].PARAMETER_ATTRIBUTES] = attributes;
      params[_constants["default"].PARAMETER_PAGE] = 1;
    ...
    removeAllAttribsAndRefresh: function removeAllAttribsAndRefresh() {
      var params = this.getSearchParams();
      params[_constants["default"].PARAMETER_PAGE] = 1;
      delete params[_constants["default"].PARAMETER_ATTRIBUTES];
      document.location.search = '?' + $.param(params);
    }
  }
};
